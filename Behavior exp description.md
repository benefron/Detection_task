...
Default settings are loaded for each new animal. After changing parameters, press **F2** to apply the updated settings, then press **F12** to start or restart the session.
